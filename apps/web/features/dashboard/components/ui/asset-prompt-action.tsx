export const AssetPromptAction = ({ className, ...props }: React.ComponentProps<"div">) => (
  <div
    className="flex items-center justify-center border-2 border-dashed text-primary text-sm cursor-pointer hover:border-primary/80 transition-colors rounded-2xl p-16 flex-col w-fit gap-3"
    {...props}
  />
)
