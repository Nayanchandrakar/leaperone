...
import { NotificationDuration } from "@/features/dashboard/components/pages/notifications/notification-duration"
...
export const CardScanPanel = ({ value, onTrigger, checkIsOpen }: CardScanPanelProps) => {
