...
export function MetricCard({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
export function MetricCardLabel({ className, ...props }: React.ComponentProps<"p">) {
  return <p className={cn("font-normal text-sm text-muted-foreground", className)} {...props} />
}

export function MetricCardValue({ className, ...props }: React.ComponentProps<"span">) {
