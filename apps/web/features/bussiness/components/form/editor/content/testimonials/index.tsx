...
export function TestimonialsSectionForm({ sectionIdx, id }: TestimonialsSectionFormProps) {
  ...
  return (
    ...
    >
      <FieldGroup className="p-5">
        ...
        <TestimonialsList sectionIdx={sectionIdx} />
        <AddTestimonialForm sectionIdx={sectionIdx} />
      </FieldGroup>
      <EditorBlockFooter>
