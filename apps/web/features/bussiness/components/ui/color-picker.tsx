...
export const ColorPicker = ({ disabled, className, ...props }: React.ComponentProps<"input">) => {
  return (
    <div
      role="group"
    ...
    >
      <button
        ...
        className="w-14 h-full bg-primary cursor-pointer group-data-[disabled=true]/color-picker-group:pointer-events-none group-data-[disabled=true]/color-picker-group:opacity-50"
      />
