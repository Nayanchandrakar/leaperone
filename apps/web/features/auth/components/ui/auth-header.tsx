...
export const AuthHeader = ({ className, ...props }: React.ComponentProps<"div">) => {
  return (
    <div className={cn("flex flex-col items-center gap-3 text-center", className)} {...props} />
  )
}

export const AuthTitle = ({ className, ...props }: React.ComponentProps<"h1">) => {
  return <h1 className={cn("text-3xl font-bold", className)} {...props} />
}

export const AuthDescription = ({ className, ...props }: React.ComponentProps<"p">) => {
