export const MSG = {
  ...
  USER: {
    ...
    SELF_RESTRICT_DENIED: "You cannot restrict or unrestrict yourself",
    RESTRICTED_USER: "The account has been restricted.",
    UNRESTRICTED_USER: "The account has been unrestricted.",
  ...
  INVITATION: {
    ...
    IMPERSONATE_SUCCESS: "Successfully switched to member account.",
  ...
  ANALYTICS: {
    ...
    OVERVIEW_NOT_FOUND: "Dasboard overview not found",
  },
} as const
